...
export function WhatsAppFab() {
  ...
  return (
    <a
      ...
      className="fixed bottom-24 right-4 z-[70] flex h-14 w-14 items-center justify-center rounded-full bg-[#25d366] text-white shadow-xl shadow-emerald-900/25 ring-4 ring-white/60 transition hover:scale-105 hover:bg-[#1eb45a] active:scale-95 sm:bottom-6 sm:right-6"
    >
